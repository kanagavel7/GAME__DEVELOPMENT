...
void main()
{
    ...
    while (1)
    {
        ...
        case 1:
            ...
            cleardevice();
            for (i = 0; i < n; i++)
                line(320 + a[i][0], 240 - a[i][1],
                     320 + a[i + 1][0], 240 - a[i + 1][1]);
        ...
        case 2:
            ...
            cleardevice();
            for (i = 0; i < n; i++)
                line(320 + a[i][0] + x, 240 - (a[i][1] + y),
                     320 + a[i + 1][0] + x, 240 - (a[i + 1][1] + y));
        ...
        case 5:
            ...
            if (ch == 4) line(0, 479, 639, 0);
            if (ch == 5) line(0, 0, 639, 479);
        ...
        case 6:
            ...
            case 1:
                ...
                cleardevice();
                for (i = 0; i < n; i++)
                    line(320 + c[i][0], 240 - c[i][1],
                         320 + c[i + 1][0], 240 - c[i + 1][1]);
...
<img width="611" height="447" alt="Screenshot 2025-09-26 102907" src="https://github.com/user-attachments/assets/0c65d5c0-48f8-470b-9b65-003606392731" />

<img width="438" height="222" alt="Screenshot 2025-09-26 102930" src="https://github.com/user-attachments/assets/6fa9603e-3952-4570-9d80-e42332f07c19" />

<img width="634" height="482" alt="Screenshot 2025-09-26 102847" src="https://github.com/user-attachments/assets/dea8fbce-ee7b-436a-841d-d880280c5787" />
